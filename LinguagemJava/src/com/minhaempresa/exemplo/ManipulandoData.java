...
public class ManipulandoData {
   ...
   */
        ...
        date = new Date(System.currentTimeMillis());//Inserido como parâmetro um long representando um instante no tempo.
        System.out.println("A data atual é "  + date);
    ...
    /*
           ...
           o Z indica que é um horário UTC ou seja o horário de Greenwich
    ...
    */
        ...
        calendar.add(Calendar.DAY_OF_MONTH, 1);//adicionei 1 mês
