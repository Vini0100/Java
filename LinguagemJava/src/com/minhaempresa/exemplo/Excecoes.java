...
public class Excecoes {
    ...
    /*
        Qualquer erro lançado pelo programa quando em execução é chamado de exceção (Exception)
        ...
        Tratar exceções nos permite que erros sejam tratados de forma consistente onde podemos:
            - Saber como tratar o erro e resolve-lo sem precisar parar o programa;
    ...
    */
    ...
    public static void metodoQueLancaUmaException(ContaCorrente contaCorrente) throws Exception {
        contaCorrente.imprimirSaldo();
    }
